...
metadata {
	...
	definition (name: "RF Ceiling Fan with Etekcity Switch Arduino", namespace: "tamttt", author: "tamttt") {
        capability "Switch"
		...
		attribute "fan4off", "string"
		attribute "light4", "string"		
